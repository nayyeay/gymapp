...
const HangingLegRaisesScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Latihan Hanging Leg Raises</Text>
      
      <Image source={require('../assets/hanging_leg_raises.jpg')} style={styles.image} />
      
      <Text style={styles.description}>
      Palang ini harus stabil dan mampu menopang seluruh berat badan Anda, serta menahan tekanan yang ditambahkan saat Anda menaikkan dan menurunkan kaki.
      </Text>
...
export default HangingLegRaisesScreen;
