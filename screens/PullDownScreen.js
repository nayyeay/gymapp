...
const PullDownScreen = () => {
  ...
  const startExercise = () => {
    ...
    //mengapa bernilai true karena ada kondisi dimana konidisinya sama true maka akan muncul tombol tambah push-an
    setPushUpCount(0);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Latihan Pull Down</Text>
      
      <Image source={require('../assets/pull_down.jpeg')} style={styles.image} />
      
      <Text style={styles.description}>
      Lat Pulldown merupakan latihan yang memanfaatkan multisendi yang menyasar ke otot lattisimus dorsi atau lats
      </Text>
      ...
      {isExerciseInProgress && (
        <View>
          <Text style={styles.pushUpCount}>Jumlah Pull Down: {pushUpCount}</Text>
          <TouchableOpacity style={styles.pushUpButton} onPress={handlePushUp}>
            <Text style={styles.pushUpButtonText}>Tambah Pull Down</Text>
          </TouchableOpacity>
        </View>
      )}
    </View>
